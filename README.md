...
## Лекция от 11.02.2023:

Основные темы:
- установка необходимых для работы на курсе инструментов;
- изучение принципов работы веб-браузера;
- изучение структуры HTML-документа и правил работы с CSS.
